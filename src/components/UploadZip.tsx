        ...
        try {
            ...
            if (file.size > 10 * 1024 * 1024) {
                ...
                workerRef.current.onerror = (err) => {
                    ...
                    setState({ status: "error", message: "Background parser failed. Try a smaller file." });
                };
                    ...
                    <div className="rounded-xl border border-white/10 bg-black/20 p-4">
                        {jsonFilenames.length === 0 ? (
                            <div className="text-sm text-white/70 space-y-3">
                                ...
                                <p>
                                    This usually means you downloaded the default "HTML" export from Instagram.
                                    This tool requires the <b>JSON</b> format.
                                </p>
                                <div className="rounded bg-white/5 p-3">
                                    <p className="font-semibold text-xs uppercase tracking-wider text-white/50 mb-2">How to get JSON export:</p>
                                    <ol className="list-decimal list-inside space-y-1 ml-1 opacity-90">
                                        <li>Go to <b>Your Activity</b> {'>'} <b>Download Your Information</b></li>
                                        <li>Start a new download request</li>
                                        <li>Select <b>"Followers and Following"</b> (or everything)</li>
                                        <li>
                                            ...
                                            {err && (
                                                <details className="group">
                                                    ...
                                                    <div className="mt-2 rounded-lg border border-red-500/20 bg-red-500/10 p-3 text-xs text-red-200">
                                                        ...
                                                        <div className="font-semibold">Preview (First 200 chars):</div>
